...
if System.get_env("DB_SSL") || "off" == "on" do
  config :meerkat, Meerkat.Repo,
    username: System.get_env("DB_USERNAME") || "meerkat",
    password: System.get_env("DB_PASSWORD") || "meerkat",
    hostname: System.get_env("DB_HOSTNAME") || "localhost",
    database: System.get_env("DB_DATABASE") || "meerkat_dev",
    port: String.to_integer(System.get_env("DB_PORT") || "5432"),
    maintenance_database: System.get_env("DB_DATABASE") || "meerkat_dev",
    stacktrace: true,
...
config :meerkat, MeerkatWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/meerkat_web/(live|views)/.*(ex)$",
      ~r"lib/meerkat_web/templates/.*(eex)$"
    ]
  ]
