...
defmodule MeerkatWeb.MiscController do
  @moduledoc """
  Misc Controller
  """
  ...
  def install(conn, params) do
    ...
    config_results =
      InstallModule.store_configs(%{
        app_name: ValidatorService.get_str(params["app_name"], "Meerkat"),
        app_url: ValidatorService.get_str(params["app_url"], "http://meerkat.sh"),
        app_email: ValidatorService.get_str(params["app_email"], "no_reply@meerkat.sh"),
        app_key: app_key
      })
