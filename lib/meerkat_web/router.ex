...
defmodule MeerkatWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {MeerkatWeb.LayoutView, :root}
    plug :protect_from_forgery
    plug :put_secure_browser_headers
    plug Meerkat.Middleware.Logger
    plug Meerkat.Middleware.UIAuthMiddleware
  end

  pipeline :api do
    plug :accepts, ["json"]
    plug Meerkat.Middleware.Logger
    plug Meerkat.Middleware.APIAuthMiddleware
  end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: MeerkatWeb.Telemetry
    end
  end
