defmodule Scuti.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule ScutiWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :scuti

       ...

       plug PromEx.Plug, prom_ex_module: Scuti.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: ScutiWeb.Router, endpoint: ScutiWeb.Endpoint}
      # Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:scuti, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
